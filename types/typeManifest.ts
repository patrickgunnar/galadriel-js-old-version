...
type aspectRatio = 'proportion-square' | 'proportion-auto' | 'proportion-landscape' | 'proportion-portrait' | 'proportion-traditional-photo';
 ...
 /**
 * Options to graceController:
 * element-button-light-gray, element-button-light-gold, element-button-gold, element-button-dark-gold, element-button-old-gold, element-button-light-blue, element-button-sky-blue, element-button-turquoise-blue, element-button-pink, element-button-dark-coral-pink, element-button-light-olive-green, element-button-olive-green, element-button-dark-olive-green, element-button-deep-olive-green, element-button-deep-indigo, element-button-indigo, element-button-light-indigo, element-button-silver, element-button-deep-teal, element-button-deep-ruby, element-button-dark-ruby, element-button-ruby, element-button-light-ruby, element-button-light-orchid, element-button-orchid, element-button-dark-orchid, element-button-deep-orchid, element-button-electric-blue, element-button-emerald-green, element-button-bright-green, element-button-vivid-orange, element-button-bold-red
 */
type graceController = 'element-button-light-gray' | 'element-button-light-gold' | 'element-button-gold' | 'element-button-dark-gold' | 'element-button-old-gold' | 'element-button-light-blue' | 'element-button-sky-blue' | 'element-button-turquoise-blue' | 'element-button-pink' | 'element-button-dark-coral-pink' | 'element-button-light-olive-green' | 'element-button-olive-green' | 'element-button-dark-olive-green' | 'element-button-deep-olive-green' | 'element-button-deep-indigo' | 'element-button-indigo' | 'element-button-light-indigo' | 'element-button-silver' | 'element-button-deep-teal' | 'element-button-deep-ruby' | 'element-button-dark-ruby' | 'element-button-ruby' | 'element-button-light-ruby' | 'element-button-light-orchid' | 'element-button-orchid' | 'element-button-dark-orchid' | 'element-button-deep-orchid' | 'element-button-electric-blue' | 'element-button-emerald-green' | 'element-button-bright-green' | 'element-button-vivid-orange' | 'element-button-bold-red';
