...
const expectedProperties = {
    ...
    borderRightStyles: "border-right-style",
    ...
    visited: "&:visited",
    checked: "&:checked",
    minLargeDesktops: "$min-width: 1200px",
    minStandardDesktops: "$min-width: 992px",
    minPortraitTablets: "$min-width: 768px",
    minLargeSmartphones: "$min-width: 426px",
    minStandardSmartphones: "$min-width: 320px",
    maxLargeDesktops: "$max-width: 1199px",
    maxStandardDesktops: "$max-width: 991px",
    maxPortraitTablets: "$max-width: 767px",
    maxLargeSmartphones: "$max-width: 480px",
    maxStandardSmartphones: "$max-width: 425px",
};

describe("Verify the coreDynamicProperties", () => {
    test("Check if the objects are being returned", () => {
        expect(coreDynamicProperties).toEqual(expectedProperties);
    });
});
