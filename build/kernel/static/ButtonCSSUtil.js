...
exports.ButtonCSSUtil = void 0;
exports.ButtonCSSUtil = {
    /*
        CUSTOM CLASSES FOR ELEMENTS
    */
    graceController: ({ extractGaladrielClasses }) => {
        const genButton = ({ bgColor, borderColor, bsColorOne, bsColorTwo, filterColor, textColor, }) => ({
            background: bgColor,
    ...
    simplifiedButton: ({ extractGaladrielClasses }) => {
        const genButton = ({ bgColorStart, bgColorEnd, borderColor, focusColor, shadowColor, }) => ({
