...
const CSSUtil = {
    /*
        STATIC CLASSES
    */
    display: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    position: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    overflowX: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    overflowWrap: ({ extractGaladrielClasses }) => extractGaladrielClasses({
        ".$excess-wrap-normal": { "overflow-wrap": "normal" },
        ".$excess-wrap-break-word": { "overflow-wrap": "break-word" },
    }),
    whiteSpace: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    listStyleType: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    textAlign: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    verticalAlign: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    wordBreak: ({ extractGaladrielClasses }) => extractGaladrielClasses({
        ".$word-rupture-normal": { "word-break": "normal" },
        ".$word-rupture-break-all": { "word-break": "break-all" },
    }),
    fontWeight: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    textDecoration: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    boxSizing: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    cursor: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    pointerEvents: ({ extractGaladrielClasses }) => extractGaladrielClasses({
        ".$event-indicator-auto": { "pointer-events": "auto" },
        ".$event-indicator-none": { "pointer-events": "none" },
    }),
    outlineStyle: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    boxShadow: ({ extractGaladrielClasses }) => extractGaladrielClasses({
        ".$container-shadow-none": { "box-shadow": "none" },
    }),
    textTransform: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    transitionProperty: ({ extractGaladrielClasses }) => extractGaladrielClasses({
        ".$transition-state-all": { "transition-property": "all" },
        ".$transition-state-none": { "transition-property": "none" },
    }),
    transitionTimingFunction: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    flexDirection: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    flexWrap: ({ extractGaladrielClasses }) => extractGaladrielClasses({
        ".$flex-enclose-nowrap": { "flex-wrap": "nowrap" },
        ".$flex-enclose-wrap": { "flex-wrap": "wrap" },
        ".$flex-enclose-wrap-reverse": { "flex-wrap": "wrap-reverse" },
    }),
    justifyContent: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    justifySelf: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    justifyItems: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    alignItems: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    alignSelf: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    alignContent: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    textJustify: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    quote: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    columnCount: ({ extractGaladrielClasses }) => extractGaladrielClasses({
        ".$tower-count-auto": { "column-count": "auto" },
    }),
    columnGap: ({ extractGaladrielClasses }) => extractGaladrielClasses({
        ".$pedestal-gap-normal": { "column-gap": "normal" },
    }),
    aspectRatio: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    objectPosition: ({ extractGaladrielClasses }) => extractGaladrielClasses({
    ...
    objectFit: ({ extractGaladrielClasses }) => extractGaladrielClasses({
